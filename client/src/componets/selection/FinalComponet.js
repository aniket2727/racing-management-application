  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className="max-w-2xl p-6 bg-white rounded-md shadow-md">
        <h1 className="text-3xl font-bold mb-4 text-gray-800">Final Round</h1>
          ...
          allfinalcarts.map((item, index) => (
            <div key={index} className="flex flex-col items-center my-4 border border-gray-300 p-4">
              <div className="abc flex">
                <h1 className="text-xl mb-2">Nandi: {item.firstName1}</h1>
                <h1 className="text-xl mb-2">Nandi: {item.firstName2}</h1>
              </div>
              <div className="abc flex">
                <h1 className="text-xl mb-2">Owner: {item.ownerName1}</h1>
                <h1 className="text-xl mb-2">Owner: {item.ownerName2}</h1>
              </div>
              <div>
